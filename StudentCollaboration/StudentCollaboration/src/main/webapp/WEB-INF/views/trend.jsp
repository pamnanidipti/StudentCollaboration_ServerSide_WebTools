...
<head>
 ...
 <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/trendstyle.css">
<style>
.mydiv{
  margin-right: -15px;
}
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top, #myScrollspy">
    ...
    <div class="container">
      <div class="navbar-header">
        <button class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
          ...
          <a class="navbar-brand" href="gradRoomFinal.html"><img src="${pageContext.request.contextPath}/resources/img/gradLogo.png" width="160" height="35"></a>
      ...
      <div class="collapse navbar-collapse" id="myNavbar" >
        ...
        <li class="dropdown" style="z-index:90001;">
          <button class="dropbtn" > <a class="page-scroll" href="gradRoomFinal.html#msinus" >MS in US</a> &#9662</button>
          <div class="dropdown-content">
            <a href="listofuniversities.html">List Of Universities</a>
            <a href="trend.html">Admit Trends</a>
            <a href="forums.html">Discussion forum</a>
          </div>
        </li>
        <li class="dropdown" style="z-index:90000;">
          <button class="dropbtn"><a class="page-scroll" href="gradRoomFinal.html#resources" >Resources</a> &#9662</button>
          <div class="dropdown-content">
        ...
        <li>
           <a class="page-scroll" href="gradRoomFinal.html#aboutus" style="font-size:16px">About us</a>
       </li>
        <li>
           <a class="page-scroll" href="gradRoomFinal.html#contact" style="font-size:16px">Contact</a>
       </li>
...
<div class="container mydiv" id="mydiv1">
 
  
    <div class="row">
        <div class="col-sm-2" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-offset-top="120" data-spy="affix">
                <li class="active"><a href="#section1">Admit Trends By Universities</a></li>
                <li ><a href="#section2" class="active" >Latest Admit Statistics</a></li>
        ...
        <div class="col-sm-10">
          <div id="section1">
              <h1 id="ad"><center><br>Admit Trends By Universities<br> </h1> <br>
        <script src="https://code.highcharts.com/highcharts.js"></script>

<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"> 

        <div class="col-sm-10" id="myScrollspy"></div></div></div>  
      <div id="section2">
        <br>
        <div id="fall_2011">
 ...
 <br/> 
<h1 id="ad"><b><center><br>Latest Admit Statistics</h1>
 <br/><br/> <br/> 
    <div id="labels">
      <center><ul>
        <li><span></span>ASU : 61.79%&nbsp&nbsp&nbsp&nbsp</li>
        <li><span></span>UTD : 24.56%&nbsp&nbsp&nbsp&nbsp</li>
        <li><span></span>NEU : 6.03%&nbsp&nbsp&nbsp&nbsp</li>
        <li><span></span>NYU : 4.91%&nbsp&nbsp&nbsp&nbsp</li>
        <li><span></span>UCLA : 2.73%</li>
      </ul><br>
    </div>
   <div id="btn_panel"><br>
      <ul><li ><a href="#fall_2011"><center><h3>Click here for <br>Fall 2015 Statistics</a></li></ul>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Admit Trend Statistics by the Semester'
        },
        xAxis: {
            categories: [
                'Fall 2010',
        ...
        series: [{
            name: 'ASU',
            data: [12000, 8000, 7000, 10000, 6000, 3000, 13000, 12000, 11022, 10000]

        }, {
            name: 'UTD',
            data: [8000, 7500, 17000, 20000, 26000, 30000, 23000, 22000, 21022, 15000]
