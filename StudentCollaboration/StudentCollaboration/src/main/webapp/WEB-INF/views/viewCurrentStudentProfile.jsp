...
<td>University:</td>
<td>
<input type="text" name="university" value="${sessionScope.searchPerson.university}" disabled>
...
<td> 
<input type = "text" id="courseApplied" name="courseApplied" value="${sessionScope.searchPerson.course}" disabled>
</td>
</tr>
...
<br/><br/>
Review / Comment about the University<br/>
<textarea rows="3" cols="50" name="review" id="review" disabled>
${sessionScope.searchPerson.review}
</textarea>
<br/><br/>
</div>
</div>
